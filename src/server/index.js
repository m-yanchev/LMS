...
import YandexCloudObjectStorage from "./YandexCloudObjectStorage";
...
async function startServer(): Promise<void> {
    ...
    const dataAPI = await DB.open()
    const loggerAPI = WinstonLogger.create()
    const objectStorageAPI = YandexCloudObjectStorage.create()
    const apolloServer = await ApolloServer.create({dataAPI, objectStorageAPI, loggerAPI})
