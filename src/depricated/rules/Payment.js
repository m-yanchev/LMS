...
class Payment {
    ...
    static _auth() {
        return process.env.NODE_ENV === 'production' ? YANDEX_PAYMENT_AUTH_PROD : YANDEX_PAYMENT_AUTH_TEST
    }
