...
import {SimpleText, SubtitleText, Title, CardText, B} from "../../../../depricated/common/components/Text";
import {ERROR_MESSAGE_P1, ERROR_MESSAGE_P2, ERROR_TITLE} from "../../../../depricated/common/constants";
...
import {LessonPaper} from "../../../entryPoints/main/components/common/Paper";
...
import {GetWebinarLinkButton, WebinarPaymentScript} from "../../../../depricated/common/components/GetWebinarLink";
import {Course} from "../../../../depricated/rules/Course";
import type {FailProps} from "../../../../depricated/common/FailLogLoader";
import {DataSource} from "../../../../depricated/rules/DataSource/DataSource";
import type {LessonProps} from "../../../../depricated/rules/Lesson";
...
import Topic from "../../../../depricated/rules/Topic";
...
export default function CoursePage(props: CoursePageProps) {
    ...
    function CourseView(props) {
        ...
        const test = lesson ? lesson.test : null
        return <>
            ...
            {state.view === "base" &&
            <> {topic &&
            <Lessons actualLessonIndex={topic.actualLessonIndex} lessons={topic.lessons}/>}
            {course.webinar &&
        ...
        function Lessons(props) {
            const actualIndex = props.actualLessonIndex;
