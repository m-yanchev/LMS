...
import {CardText, SimpleText, SubtitleText} from "../../../../depricated/common/components/Text";
import {OutlinedButton} from "../../../../depricated/course/Buttons";
import {LessonGrid} from "../../../entryPoints/main/components/common/Boxes";
import {
    CARD_SPACE, CARD_WIDTH, IMAGE_PREFIX, IMAGE_SUFFIX, IMAGES_FOLDER, VIDEO_POSTERS_FOLDER
} from "../../../../depricated/common/constants";
...
import {Lesson as LessonObject} from "../../../../depricated/rules/Lesson"
...
export default function Lesson(props: LessonProps) {
    ...
    return <>
        ...
        {state.test && <>
            <TestDialog key={state.test.id} open={state.dialog === "test"} test={state.test}
                        onCloseCall={handleCloseTestDialog}/>
    ...
    function TestCard(props) {
        ...
        const content = {
            ...
            isPending: test.isPendingVerificationSolution
        }
