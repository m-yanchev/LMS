...
function configStrategies() {
    ...
    passport.use(new VKontakteStrategy({
            clientID: 7539086,
            clientSecret: "JOS3DnNERbX3cAdwKzGs",
    ...
    passport.use(new GoogleStrategy({
            clientID: "532018501067-ln69l3ge09t2170b0n6e3t89jughkhki.apps.googleusercontent.com",
            clientSecret: "wS_oQ91-Wz972zNNjfb35rMf",
...
function initPassport(app) {
    ...
    const store = new MongoDBStore({
        uri: 'mongodb://teacher:xjkYX2t5Nm@localhost:27017',
